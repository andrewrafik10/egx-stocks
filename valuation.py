...
def dcf_valuation(cf: CompanyFundamentals, macro_sector: str = "Other") -> Tuple[Optional[float], str]:
    """Simplified FCFE-style DCF per share using sector-specific cost of equity."""
    ...
    return value_per_share, f"FCF growth {g0:.1%} fading to {gt:.1%}, r={r:.1%} ({macro_sector}), {n}yr"
...
def run_all_methods(cf: CompanyFundamentals, sector_median_pe: Optional[float],
    ...
    for name, fn_result in [
        ...
        ("dcf", dcf_valuation(cf, macro_sector)),
